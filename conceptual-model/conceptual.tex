...
\begin {tikzpicture}
    ...
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (1.5,-8) (component) {component};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (4.5,-8) (parameter) {parameter};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-6.75) (design) {design};
    ...
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (0,-5.25) (calculationE) {calculation expression};

    \draw (component) to (parameter);
    ...
    \draw (calculationE) -- (designElement);
