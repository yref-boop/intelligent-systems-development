...
\begin {tikzpicture}
    ...
    \begin {class} [rectangle split parts = 2, text width = 4cm] {Preferencias} {3,6}
        ...
        \attribute {comportamiento coche : enun \{\}}
    \end {class}
    ...
    \begin {class} [rectangle split parts = 2, text width = 5.5cm] {Propiedades Circuito} {3,15}
        \attribute {tracción : enum \{\}}
        \attribute {frenada : enum \{\}}
        \attribute {fuerza lateral : enum \{\}}
        \attribute {estrés ruedas : \{\}}
        \attribute {evolución de la pista : enum\{\}}
        \attribute {agarre del asfalto : enum\{\}}
        \attribute {carga aerodinámica : enum \{\}}
        ...
        \attribute {compuesto neumatico duro : enum \{\}}
        \attribute {compuesto neumatico medio : enum \{\}}
        \attribute {compuesto neumatico blando : enum \{\}}
