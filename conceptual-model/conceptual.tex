...
\begin{tikzpicture}
    \begin{class}[text width=4cm]{Requisitos}{0,0}
        \attribute{PreferenciasPiloto : piloto}
        \attribute{Circuito : circuito}
        \attribute{Meteorologia : meteorologia}
    \end{class}
    \begin{class}[yshift=-15mm, text width = 3.5cm]{Meteorologia}{Requisitos.south}
        ...
        \inherit {Requisitos}
    \end{class}
    \begin{class}[xshift=-32mm, text width = 4cm]{PreferenciasPiloto}{Meteorologia.north west}
        \attribute {String : tipoConduccion}
        \inherit {Requisitos}
    \end{class}
    \begin{class}[xshift=+32mm, text width = 3cm]{Circuito}{Meteorologia.north east}
...
\\ [10px]
\begin {tikzpicture}
    \begin {class} [text width = 3cm] {Coche} {0,0}
...
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (skeletal) {skeletal design};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (propose) {propose};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (extension) {extension};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,-2) (designe) {designe};

    \draw [-latex] (skeletal) to (propose);
    \draw [-latex] (propose) to (extension);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (skeletal) edge (designa);
    \draw [-latex] (extension) edge (designe);
\end {tikzpicture}
\hspace {1cm}
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (design) {design};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (propose) {propose};
    ...
    \draw [-latex] (propose) to (extension);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (design) edge (designa);
    \draw [-latex] (extension) edge (designe);
\end {tikzpicture}
\\[1cm]
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (soft) {soft requirements};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (propose) {propose};
...
\begin {tikzpicture}
    ...
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (verify) {verify};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (truth) {truth value};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [-latex] (design) to (verify);
    \draw [-latex] (verify) to (truth);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (design) edge (designa);
    \draw [-latex] (truth) edge (designe);
\end {tikzpicture}
\hspace {1cm}
\begin {tikzpicture}
     \node [draw,
    ...
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (violation) {violation};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (design) edge (designa);
    \draw [-latex] (violation) edge (designe);
\end {tikzpicture}
\\[1cm]
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (hard) {hard requirements};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (verify) {verify};
    ...
    \draw [-latex] (hard) to (verify);
    \draw [-latex] (verify) to (truth);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (hard) edge (designa);
    \draw [-latex] (truth) edge (designe);
\end {tikzpicture}
\hspace {1cm}
\begin {tikzpicture}
...
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (extension) {extension};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (verify) {verify};
    ...
    \draw [-latex] (verify) to (truth);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (extension) edge (designa);
    \draw [-latex] (truth) edge (designe);
\end {tikzpicture}
\hspace {1cm}
\begin {tikzpicture}
...
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (violation) {violation};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (critique) {critique};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (list) {action list};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [-latex] (critique) to (list);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (violation) edge (designa);
    \draw [-latex] (list) edge (designe);
\end {tikzpicture}
\hspace {1cm}
\begin {tikzpicture}
     \node [draw,
...
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (list) {action list};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (select) {select};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (action) {action};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [-latex] (select) to (action);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (list) edge (designa);
    \draw [-latex] (action) edge (designe);
\end {tikzpicture}
\\[1cm]
\textbf {Modify}
\\[0.5cm]
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (action) {action};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (modify) {modify};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (design) {design};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [-latex] (action) to (modify);
    \draw [-latex] (modify) to (design);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (action) edge (designa);
    \draw [-latex] (design) edge (designe);
\end {tikzpicture}
\hspace* {1cm}
\begin {tikzpicture}
     \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,0) (design1) {design};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (modify) {modify};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (6,0) (design2) {design};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-2) (designa) {designa};
    \node [draw,
    ...
    \draw [-latex] (design1) to (modify);
    \draw [-latex] (modify) to (design2);
    \draw [dotted] (-1,-1) to (7,-1);
    \draw [-latex] (design1) edge (designa);
    \draw [-latex] (design2) edge (designe);
\end {tikzpicture}
