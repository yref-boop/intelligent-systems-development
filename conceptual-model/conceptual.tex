...
\begin{tikzpicture}
    ...
    \end{class}
    \begin{class}[rectangle split parts=2, yshift=-15mm, text width = 3.5cm]{Meteorologia}{Requisitos.south}
...
\\ [10px]
\begin {tikzpicture}
    \begin {class} [rectangle split parts=2, text width = 3cm] {Coche} {0,0}
