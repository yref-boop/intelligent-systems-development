...
\newcommand {\inference}[5] {
    \begin {tikzpicture}
        ...
        \draw [-latex] (input) edge (input_type);
        \draw [-latex] (output) edge (output_type);
    \end {tikzpicture}
}
...
\textbf {Propose}
\\[0.5cm]
\inference {skeletal design}{propose}{extension}{In}{Out}
\hspace {1cm}
\inference {design}{propose}{extension}{In}{Out}
\\[1cm]
\inference {soft requirements}{propose}{extension}{In}{Out}
\\[1cm]
\textbf {Verify}
\\[0.5cm]
\inference {design}{verify}{truth value}{In}{Out}
\hspace {1cm}
\inference {design}{verify}{violation}{In}{Out}
\\[1cm]
\inference {hard requirements}{verify}{truth value}{In}{Out}
\hspace {1cm}
\inference {hard requirements}{verify}{violation}{In}{Out}
\\[1cm]
\inference {extension}{verify}{truth value}{In}{Out}
\hspace {1cm}
\inference {extension}{verify}{violation}{In}{Out}
\\[1cm]
\textbf {Critique}
\\[0.5cm]
\inference {violation}{critique}{action list}{In}{Out}
\hspace {1cm}
\inference {design}{critique}{action list}{In}{Out}
\\[1cm]
\textbf {Select}
\\[0.5cm]
\inference {action list}{select}{action}{In}{Out}
\\[1cm]
\textbf {Modify}
\\[0.5cm]
\inference {action}{modify}{design}{In}{Out}
\hspace {1cm}
\inference {design}{modify}{design}{In}{Out}
