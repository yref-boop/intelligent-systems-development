...
\begin {tikzpicture}
    ...
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (3,0) (fixes) {fixes};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (3,-2) (fixAction) {fix action};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (3,-4) (constraint) {constraint};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (3,-6) (designElement) {design element};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-5.5) (component) {component};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (0,-7) (parameter) {parameter};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (3,-8) (design) {design};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (1.75,-9.5) (preference) {preference};
    \node [draw,
        minimum width=2cm,
        minimum height=1cm] at (4.25,-9.5) (property) {property};


    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (6,-3) (critiqueE) {critique expression};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (6,-5) (constraintE) {constraint expression};
    \node [draw,
        rounded corners = 0.5cm,
        minimum width=2cm,
        minimum height=1cm] at (6,-7) (calculationE) {calculation expression};

    \draw [-latex] (component) to (parameter);
    \draw [-{Latex[open]}] (component) to (designElement);
    \draw [-{Latex[open]}] (parameter) to (designElement);
    \draw [-{Diamond[open]}] (design) to (designElement);
    \draw (calculationE) -- (3,-7);

    \draw (designElement) to (8,-6);
    \draw (8,-6) to (8,-2);
    \draw (fixAction) to (8,-2);

    \draw (designElement) -- (constraint);
    \draw (constraint) -- (fixAction);
    \draw [-{Diamond[open]}] (fixes) -- (fixAction);

    \draw (critiqueE) -- (3,-3);
    \draw (constraintE) -- (3,-5);

    \draw (preference) -- (design);
    \draw (property) -- (design);
